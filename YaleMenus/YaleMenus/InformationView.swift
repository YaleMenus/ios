    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            ScrollView {
                ...
                ParagraphView(text: "This app was built by Erik Boesen (Hopper '24) and Eric Foster (Hopper '20), with help from Jacob Malinowski (Hopper '20) and David Foster (Hopper '23).")
            }
        }.padding()
    }
}
