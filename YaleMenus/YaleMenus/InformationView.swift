    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            ScrollView {
                ...
                ParagraphView(text: "This app was built by Erik Boesen (Hopper '24) and designed by David Foster (Hopper '23), based on the original app by Eric Foster (Hopper '20).")
            }
        }.padding()
    }
}
